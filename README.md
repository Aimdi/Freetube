...
This repository is a fork of [FreeTubeAndroid](https://github.com/MarmadileManteater/FreeTubeAndroid) with **Android system Picture-in-Picture**.
...
Android 10+ can keep a playing video in a floating system PiP window while you use other apps.
...
* Android system Picture-in-Picture (Home / player button, with play-pause controls)
